In this project , we try some advanced methods to improve the performance of models which are trained on imbalanced datasets.
...
the first transaction in the dataset. The feature 'Amount' is the transaction Amount, this feature can be used for example-dependant cost-sensitive learning. 
...
1. Class Weights initialization
2. Oversampling of imbalanced dataset
